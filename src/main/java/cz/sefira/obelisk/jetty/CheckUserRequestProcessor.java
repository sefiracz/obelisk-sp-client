package cz.sefira.obelisk.jetty;

import cz.sefira.obelisk.NexuException;
import cz.sefira.obelisk.api.EnvironmentInfo;
import cz.sefira.obelisk.process.NativeProcessExecutor;
	...
	public CheckUserRequestProcessor() {
		try {
			...
			case WINDOWS:
				...
				userByPIDStrategy = Class.forName("cz.sefira.obelisk.jetty.Win32JNAUserByPIDStrategy").asSubclass(
