 ...
 * http://www.sefira.cz
 *
 * lu.nowina.nexu.view.BusyIndicator
 *
 * Created: 01.09.2021
 * Author: hlavnicka
 */
...
public class BusyIndicator implements Closeable {
  ...
  private void show() {
    Platform.runLater(() -> {
      ...
      stage.setTitle(AppPreloader.getConfig().getApplicationName());
      stage.setAlwaysOnTop(true);
      stage.initStyle(StageStyle.TRANSPARENT);
      stage.getIcons().add(new Image(AppPreloader.class.getResourceAsStream("/tray-icon.png")));
      stage.show();
    });
  }
