...
public interface SignatureTokenConnection extends AutoCloseable {
	 ...
	 */
	SignatureValue sign(byte[] toBeSigned, DigestAlgorithm digestAlgorithm, DSSPrivateKeyEntry keyEntry) throws DSSException;
	 ...
	 *             If there is any problem during the signature process
	 */
	SignatureValue sign(byte[] toBeSigned, DigestAlgorithm digestAlgorithm, MaskGenerationFunction mgf, DSSPrivateKeyEntry keyEntry) throws DSSException;
