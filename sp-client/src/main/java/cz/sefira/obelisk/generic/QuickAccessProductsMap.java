 ...
 */
public class QuickAccessProductsMap {

  private static volatile QuickAccessProductsMap products;

  private final Map<String, List<AbstractProduct>> map;

  private QuickAccessProductsMap() {
    map = new HashMap<>();
  }

  public synchronized static QuickAccessProductsMap access() {
    if(products == null) {
      products = new QuickAccessProductsMap();
    }
    return products;
  }
