...
import cz.sefira.obelisk.json.pojo.TestWithCertificate;
...
//        req.setUserLocale("fr");
    ...
    public void test3() throws Exception {
        ...
        final KeyStoreSignatureTokenConnection token = new KeyStoreSignatureTokenConnection(new FileInputStream("src/test/resources/keystore.jks"), "JKS",
